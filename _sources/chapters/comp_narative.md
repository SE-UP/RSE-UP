...
**—in this section,** we walk through the AQI project notebook which lives in [computational narrative version of the Air Quality Index example](https://se-up.github.io/RSE-UP/aqi/notebooks/computational_narrative.html) step by step,
